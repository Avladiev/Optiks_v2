...
/**
 * Gesture listener for game screen buttons
 */
public class ButtonsListener implements GestureDetector.GestureListener {
    private final  GameObject[] buttons;    //may be class ButtonsObject

    public ButtonsListener(final GameObject[] buttons) {
