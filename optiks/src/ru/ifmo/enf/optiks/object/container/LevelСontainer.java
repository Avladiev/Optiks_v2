...
public class LevelСontainer {
   ...
   private List<ObjectContainer> objectContainers;
    ...
    public LevelСontainer( @NotNull final List<SimpleObjectСontainer> simpleObjectСontainers, @NotNull final List<ObjectContainer> objectContainers) {
    ...
    public boolean equals(final Object o) {
        ...
        final LevelСontainer that = (LevelСontainer) o;
